...
class LanguageServiceClient {
    ...
    constructor(opts) {
        ...
        const defaults = gaxGrpc.constructSettings('google.cloud.language.v1.LanguageService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
        ...
        this.languageServiceStub = gaxGrpc.createStub(opts.fallback
            ...
            : // tslint:disable-next-line no-any
                protos.google.cloud.language.v1.LanguageService, opts);
