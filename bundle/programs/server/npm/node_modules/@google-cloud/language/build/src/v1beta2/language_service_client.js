...
class LanguageServiceClient {
    ...
    constructor(opts) {
        ...
        const defaults = gaxGrpc.constructSettings('google.cloud.language.v1beta2.LanguageService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
        ...
        this.languageServiceStub = gaxGrpc.createStub(opts.fallback
            ? protos.lookupService('google.cloud.language.v1beta2.LanguageService')
            : // tslint:disable-next-line no-any
                protos.google.cloud.language.v1beta2.LanguageService, opts);
        ...
        for (const methodName of languageServiceStubMethods) {
            const innerCallPromise = this.languageServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=language_service_client.js.map